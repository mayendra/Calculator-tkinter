...
class Calculator :
    def __init__(self,master):
        ...
        Button(width=11,height=4,text='9',relief='flat',bg='white',command=lambda:self.show(9)).place(x=0 ,y=275)
        ...
        Button(width=11,height=4,text='C',relief='flat',command=self.clear).place(x=270 ,y=350)
